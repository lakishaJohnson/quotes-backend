...
('RELIGION', 'IF GOD DID NOT EXIST, WE MUST INVENT HIM', 'VOLTAIRE', 'NULL', 'ENGLISH', 0, TRUE),

('RELIGION', 'NO MATTER HOW STRONGLY THE WIND OF EVIL MAY BLOW, THE FLAME OF TRUTH CANNOT BE EXTINGUISHED', 'DALAI LAMA', 'NULL', 'ENGLISH', 0, TRUE),

('RELIGION', 'DO NOT DWELL IN THE PAST, DO NOT DREAM OF THE FUTURE, CONCENTRATE THE MIND ON THE PRESENT MOMENT', 'BUDDHA', 'TEACHINGS', 'PALI', 0, TRUE),
...
('WISDOM', 'IT DOES NOT MATTER HOW SLOWLY YOU GO AS LONG AS YOU DO NOT STOP', 'CONFUCIUS', 'TEACHINGS', 'CHINESE', 0, TRUE),

('PROVERB', 'धेरै चिनी तितो हुन्छ: TOO MUCH SUGAR IS BITTER', 'UNKNOWN', 'FOLK WISDOM', 'NEPALI', 0, TRUE),
...
('FUNNY', 'I''M ON A SEAFOOD DIET. I SEE FOOD, AND I EAT IT', 'UNKNOWN', 'NULL', 'ENGLISH', '0', TRUE);
